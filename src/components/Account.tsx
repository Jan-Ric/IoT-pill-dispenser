            ...
            <div className="mb-4 p-4 bg-amber-50 border border-amber-200 rounded-xl flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-xs text-amber-700 mt-1">
                  Your Arduino has 3 medicine slots (6 servos). Delete a
                  medicine to add a new one.
                </p>
              </div>
            </div>
          )}
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                          ...
                          <input
                            ...
                            className="w-full px-4 py-2.5 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-teal-400 text-sm bg-white"
                          />
                        </div>
                        <div>
                          <label className="block text-sm font-medium text-gray-700 mb-2">
                          ...
                          <input
                            ...
                            onChange={(e) =>
                              updateMedicineDosage(e.target.value)
                            }
                            className="w-full px-4 py-2.5 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-teal-400 text-sm bg-white"
                          />
                        </div>
                          ...
                          {tempMedicine.schedules.map((schedule, index) => (
                            ...
                            >
                              ...
                              <input
                                ...
                                className="flex-1 px-4 py-2 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-teal-400 text-sm bg-white"
                              />
                              <button
